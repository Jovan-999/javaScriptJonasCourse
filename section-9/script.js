...
const displayMovements = function (movements, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    // So if the current movement is greater than zero then the type should be deposit or else it should then be withdrawal.
    ...
    // right after conatinermovements parent element
  });
};
...
btnTransfer.addEventListener('click', function (event) {
  ...
  // clear inputs for transfer
  inputTransferAmount.value = inputTransferTo.value = '';

  if (
    // We cant transfer 0, over our balance, to ourself, and we check if receiveracc exist
    amount > 0 &&
    recieverAcc &&
    currentAccount.balance >= amount &&
    recieverAcc?.username !== currentAccount.username
  ) {
    // Doing the transfer current acc -, receiver +
...
// // flat method concat nested arrays
...
// 1. // how much is deposited from all accounts
...
// // whenever the current value is grater or equal than 1000, then we want to return the count + 1, otherwise we just want to return the count
...
// let a = 10;
// console.log(++a);
// prefixed ++ bcs a++ return original value
// console.log(a);
